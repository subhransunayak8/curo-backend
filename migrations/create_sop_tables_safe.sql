-- ============================================================================
-- SAFE SOP SYSTEM SETUP
-- This script safely creates SOP tables without touching existing tables
-- ============================================================================

-- Step 1: Create update function if it doesn't exist
...
-- Step 2: Create caregivers table (only if it doesn't exist)
...
-- Step 3: Create patients table (only if it doesn't exist)
...
-- Step 4: Create patient_medicines table (only if it doesn't exist)
...
-- Step 5: Create sops table (only if it doesn't exist)
...
-- Step 6: Create sop_steps table (only if it doesn't exist)
...
-- Step 8: Add triggers (drop first to avoid duplicates)
...
SELECT 
    'SUCCESS: SOP System Created!' as status,
